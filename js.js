...
const update = () => {
   ...
   if (offset > IMAGE_WIDTH) {
    ...
    if (speed > 0 || offset !== 0) {
        ...
        if (winner == 0) {
            console.log('FLOWERS');
            var elem = document.getElementById('prize');
            elem.innerHTML = "Букет квітів";
        } else if (winner == 1) {
            console.log('pizza')
            var elem = document.getElementById('prize');
            elem.innerHTML = "Піццу";
        } else if (winner == 2) {
            console.log('rolls')
            var elem = document.getElementById('prize');
            elem.innerHTML = "Суші";
            ...
            var elem = document.getElementById('prize');
            elem.innerHTML = "Квиток в кіно";
            console.log('Квиток в кіно')
        }
        else if (winner == 4) {
            var elem = document.getElementById('prize');
            elem.innerHTML = "Солодощі";
            console.log('donuts')
        }
    }
